...
export class Grid {
    ...
    constructor(width, height, canvas_id) {
        ...
        const ret = wasm.grid_new(width, height, ptr0, len0);
     ...
     */
    set_pixel(x, y, color) {
        wasm.grid_set_pixel(this.__wbg_ptr, x, y, color);
    }
    /**
     ...
     */
    render(pixel_size) {
        wasm.grid_render(this.__wbg_ptr, pixel_size);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('renderer_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
